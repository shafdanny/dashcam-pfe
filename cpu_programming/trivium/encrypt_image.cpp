...
int main()
{
    std::ifstream keyFile("../../gpu_programming/Tests/test_image_trivium.key", std::ios::in | std::ios::binary);
    std::ifstream image("../../gpu_programming/Tests/test_image.jpg", std::ios::in | std::ios::binary);
    std::ofstream imageCrypted("../../gpu_programming/Tests/test_image_trivium_crypted.jpg", std::ios::out | std::ios::binary);
    if (!imageCrypted)
    {
        std::cout << "Impossible de creer le fichier de sortie" << imageCrypted << std::endl;
    }
